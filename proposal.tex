...
% add bib entries here for your references that you want to highlight (bold)
...
%	\subsection*{Stand der Forschung und eigene Vorarbeiten}
	...
	\note{Since version 09/22 of the DFG template, your own publications~%
	\cite{Hoelzer:16, Desiro:18} and those of others, all simply show up in
	section~\ref{sec:bib} \enquote{Project- and subject-related list of
	publications}. The former subsubsections \emph{Articles published by
...
%	\subsection{Arbeitsprogramm inkl. vorgesehener Untersuchungsmethoden}
	\todo{Describe the work packages\,\ldots\ ca.\ 6\,--\,8 pages;
	ca.\ 4\,--\,8 WPs for each applicant.}
...
%	\subsubsubsection{Risiken in internationalen Kooperationen}}
	...
	\subsubsubsection{Considerations on aspects of ecological sustainability in the planning and implementation of the project}
%	\subsubsubsection{Reflexion zu ökologischen Nachhaltigkeitsaspekten in der Planung und Durchführung des Vorhabens}
	\todo{Text}
	
	
	\subsection{Employment status information}
%	\subsection{Angaben zur Dienststellung}
	\note{For each applicant, state last name, first name, and employment status
	(including duration of contract and probably funding body if on a fixed-term
	contract).}
	\todo{Text}
	
	\subsection{First-time proposal data}
%	\subsection{Angaben zur Erstantragstellung}
	\note{Only if applicable: last name, first name of the first-time applicant}
	\todo{Text}
	...
	\note{List only those individuals who will work on the project but will not
	be paid out of the project funds. State each person’s name, academic title,
	employment status, and type of funding.}
	The following individuals will work on the project but will not be paid out
...
%	\subsection{Wissenschaftlerinnen und Wissenschaftler, mit denen in den letzten drei Jahren wissenschaftlich zusammengearbeitet wurde}
	\note{This information will help avoid potential conflicts of interest.}
	\begin{itemize}
...
%	\subsection{Projektrelevante Zusammenarbeit mit erwerbswirtschaftlichen Unternehmen}
	\note{If applicable, please note the EU guidelines on state aid or contract
...
%	\subsection{Projektrelevante Beteiligungen an erwerbswirtschaftlichen Unternehmen}
	\note{If applicable, put information on connections between the project and
	the production branch of the enterprise here.}
	---\,None\,---
	
	\subsection{Scientific equipment}
%	\subsection{Apparative Ausstattung}
	\note{List larger instruments that will be available to you for the project.
	These may include large computer facilities if computing capacity will be
	needed.}
	\todo{Text}
	
	\subsection{Other submissions}
%	\subsection{Weitere Antragstellungen}
	\note{List any other funding proposals for this project and/or major
...
%	\subsection{Weitere Angaben}
	\note{Please use this section for any additional information you feel is
	relevant and that has not been provided elsewhere.}
	In submitting a proposal to the DFG, I agree to adhere to the DFG's rules
	of good scientific practice and the
...
%	\subsubsection{Personalmittel}
	\note{Explain each item for each applicant (stating last name, first name).}
...
%	\subsubsubsection{Großgeräte über 50.000 Euro}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	\vspace*{2cm}
%	\todo{The following are additional/other modules one might want to apply for.
%	Otherwise, just delete/comment}
...
%	\subsection{Modul Pauschale für Chancengleichheitsmaßnahmen}
	\note{Please detail what measures are planned to promote diversity and equal
	opportunities. If you are submitting your project proposal within a network,
	note that this standard allowance may only be applied for within the
	coordination project. The coordination project must combine all such requests
	in its calculation.}
	\todo{Text}
\end{document}
